...
";
	...
	static function html_table($page = 1,$perpage = 10,$criteria="",$action=true){
		...
		if($action){
			...
			<th>Car Number</th><th>Car Photo</th><th>Mobile</th><th>Email</th><th>Action</th></tr>";
		}else{
			$html.="<tr><th>Id</th><th>Name</th><th>Vehicle Type</th>
			<th>Car Number</th><th>Car Photo</th><th>Mobile</th><th>Email</th></tr>";
		}
		while($rider=$result->fetch_object()){
			$action_buttons = "";
			if($action){
			...
			$html.="<tr><td>$rider->id</td><td>$rider->name</td><td>$rider->vehicle_type</td><td>$rider->car_number</td><td>$rider->car_photo</td><td>$rider->mobile</td><td>$rider->email</td> $action_buttons</tr>";
		}
		$html.="</table>";
