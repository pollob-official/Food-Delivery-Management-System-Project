...
";
	...
	static function html_table($page = 1, $perpage = 10, $criteria = "", $action = true)
	{
		...
		if ($action) {
			$html .= "<tr><th>Id</th><th>Customer Id</th><th>Rider Id</th><th>Restaurant Id</th><th>Delivery Address</th><th>Total Amount</th><th>Delivery Fee</th><th>Tax Amount</th><th>Coupon Id</th><th>Tracking Id</th><th>Payment Status</th><th>Created At</th><th>Updated At</th><th>Version</th><th>Action</th></tr>";
		} else {
			$html .= "<tr><th>Id</th><th>Customer Id</th><th>Rider Id</th><th>Restaurant Id</th><th>Delivery Address</th><th>Total Amount</th><th>Delivery Fee</th><th>Tax Amount</th><th>Coupon Id</th><th>Tracking Id</th><th>Payment Status</th><th>Created At</th><th>Updated At</th><th>Version</th></tr>";
		}
		while ($order = $result->fetch_object()) {
			$action_buttons = "";
			if ($action) {
			...
			$html .= "<tr><td>$order->id</td><td>$order->customer_id</td><td>$order->rider_id</td><td>$order->restaurant_id</td><td>$order->delivery_address</td><td>$order->total_amount</td><td>$order->delivery_fee</td><td>$order->tax_amount</td><td>$order->coupon_id</td><td>$order->tracking_id</td><td>$order->payment_status</td><td>$order->created_at</td><td>$order->updated_at</td><td>$order->version</td> $action_buttons</tr>";
		}
		$html .= "</table>";
