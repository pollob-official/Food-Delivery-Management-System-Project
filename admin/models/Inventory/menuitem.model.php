...
";
	...
	static function html_table($page = 1,$perpage = 10,$criteria="",$action=true){
		...
		if($action){
			$html.="<tr><th>Id</th><th>Restaurant Id</th><th>Name</th><th>Description</th><th>Price</th><th>Is Available</th><th>Category</th><th>Photo</th><th>Created At</th><th>Action</th></tr>";
		}else{
			$html.="<tr><th>Id</th><th>Restaurant Id</th><th>Name</th><th>Description</th><th>Price</th><th>Is Available</th><th>Category</th><th>Photo</th><th>Created At</th></tr>";
		}
		while($menuitem=$result->fetch_object()){
			$action_buttons = "";
			if($action){
			...
			$html.="<tr><td>$menuitem->id</td><td>$menuitem->restaurant_id</td><td>$menuitem->name</td><td>$menuitem->description</td><td>$menuitem->price</td><td>$menuitem->is_available</td><td>$menuitem->category</td><td><img src='$base_url/img/$menuitem->photo' width='100' /></td><td>$menuitem->created_at</td> $action_buttons</tr>";
		}
		$html.="</table>";
