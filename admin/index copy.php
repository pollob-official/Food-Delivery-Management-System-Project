...
<!-- Mirrored from coderthemes.com/yum/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Oct 2025 03:27:15 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <!--  Head js -->
      <script type="module" crossorigin src="assets/auth-login-1c0b6aa4.js"></script>
            ...
            <div class="flex justify-center items-center lg:max-w-lg">
                <div class="flex flex-col h-full">
                    <div class="shrink">
                        ...
                        <form data-x-form data-x-form-to="home.html">
                            <div class="mb-6">
                                ...
                                <input data-x-field="email" id="LoggingEmailAddress" value="user@demo.com" class="block w-full rounded-full py-2.5 px-4 bg-white border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="email" placeholder="Enter your email">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex" data-x-password>
                                    <input data-x-field="password" value="password" type="password" id="form-password" class="form-password block w-full rounded-s-full py-2.5 px-4 bg-white border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50"  placeholder="Enter your password">
                                    <button type="button" id="password-addon" class="password-toggle inline-flex items-center justify-center py-2.5 px-4 border rounded-e-full bg-white -ms-px border-default-200 dark:bg-default-50">
                            ...
                            <div class="flex justify-center mb-6">
                                <button  type="submit" class="relative inline-flex items-center justify-center px-6 py-3 rounded-full text-base bg-primary text-white capitalize transition-all hover:bg-primary-500 w-full">Log In </button>
                            </div>
                            <div class="mb-6">
                    ...
                    <div class="grow flex items-end justify-center mt-16">
                        <p class="text-default-950 text-center mt-auto">Don’t have an account ? <a href="auth-register.html" class="text-primary ms-1"><span class="font-medium">Register</span></a></p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from coderthemes.com/yum/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Oct 2025 03:27:16 GMT -->
</html>
